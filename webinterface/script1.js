!(function () {
                ...
                (t.parse = function (t) {
                    ...
                    return (
                        "j" in r
                            ...
                            ? (o.setFullYear(r.y, 0, 1), o.setFullYear(r.y, 0, "W" in r ? ((r.w + 6) % 7) + 7 * r.W - ((o.getDay() + 5) % 7) : r.w + 7 * r.U - ((o.getDay() + 6) % 7)))
        ...
        return {
            ...
            point: function (i, o) {
                ...
                ga(c - qa) < Ca
                    ...
                    : u !== a && c >= qa && (ga(e - u) < Ca && (e -= u * Ca), ga(i - a) < Ca && (i -= a * Ca), (r = Ue(e, r, i, o)), n.point(u, r), n.lineEnd(), n.lineStart(), n.point(a, r), (t = 0)),
                    n.point((e = i), (r = o)),
                    (u = a);
            },
            lineEnd: function () {
    ...
    function Hu(n, t) {
        var e,
            ...
            p = o.scale;
        return (
            a[0] != c[0] || a[1] != c[1] ? (r.push("translate(", null, ",", null, ")"), u.push({ i: 1, x: vu(a[0], c[0]) }, { i: 3, x: vu(a[1], c[1]) })) : r.push(c[0] || c[1] ? "translate(" + c + ")" : ""),
            l != s ? (l - s > 180 ? (s += 360) : s - l > 180 && (l += 360), u.push({ i: r.push(r.pop() + "rotate(", null, ")") - 2, x: vu(l, s) })) : s && r.push(r.pop() + "rotate(" + s + ")"),
        ...
        (ta.geo.graticule = function () {
            ...
            return (
                ...
                (n.majorExtent = function (t) {
                    return arguments.length
                        ? ((i = +t[0][0]), (u = +t[1][0]), (l = +t[0][1]), (c = +t[1][1]), i > u && ((t = i), (i = u), (u = t)), l > c && ((t = l), (l = c), (c = t)), n.precision(y))
                        : [
                              [i, l],
                              [u, c],
                          ];
                ...
                (n.minorExtent = function (t) {
                    return arguments.length
                        ? ((r = +t[0][0]), (e = +t[1][0]), (a = +t[0][1]), (o = +t[1][1]), r > e && ((t = r), (r = e), (e = t)), a > o && ((t = a), (a = o), (o = t)), n.precision(y))
                        : [
                              [r, a],
                              [e, o],
                          ];
        ...
        (nu.prototype = {
            insert: function (n, t) {
                ...
                for (t.L = t.R = null, t.U = e, t.C = !0, n = t; e && e.C; )
                    (r = e.U),
                        e === r.L
                            ? ((u = r.R), u && u.C ? ((e.C = u.C = !1), (r.C = !0), (n = r)) : (n === e.R && (eu(this, e), (n = e), (e = n.U)), (e.C = !1), (r.C = !0), ru(this, r)))
                            : ((u = r.L), u && u.C ? ((e.C = u.C = !1), (r.C = !0), (n = r)) : (n === e.L && (ru(this, e), (n = e), (e = n.U)), (e.C = !1), (r.C = !0), eu(this, r))),
                        (e = n.U);
                this._.C = !1;
            },
            remove: function (n) {
                ...
                if (
                    ...
                    i && o ? ((r = e.C), (e.C = n.C), (e.L = i), (i.U = e), e !== o ? ((u = e.U), (e.U = n.U), (n = e.R), (u.L = n), (e.R = o), (o.U = e)) : ((e.U = u), (u = e), (n = e.R))) : ((r = n.C), (n = e)),
                    n && (n.U = u),
                    !r)
                ) {
                ...
                if ((p = Math.min(Math.abs(l - n) / 2, +u.apply(this, arguments))) > 0.001) {
                    ...
                    if (null != x) {
                        var H = Math.min(p, (l - F) / (j + 1)),
                            ...
                            I = fo([x, b], [_, w], l, H, g);
                        p === H
                            ? N.push("M", O[0], "A", H, ",", H, " 0 0,", v, " ", O[1], "A", l, ",", l, " 0 ", (1 - g) ^ so(O[1][0], O[1][1], I[1][0], I[1][1]), ",", g, " ", I[1], "A", H, ",", H, " 0 0,", v, " ", I[0])
                    ...
                    if (null != S) {
                        ...
                        p === Y
                            ? N.push("L", V[0], "A", Y, ",", Y, " 0 0,", v, " ", V[1], "A", n, ",", n, " 0 ", g ^ so(V[1][0], V[1][1], Z[1][0], Z[1][1]), ",", 1 - g, " ", Z[1], "A", Y, ",", Y, " 0 0,", v, " ", Z[0])
        ...
        (ta.svg.axis = function () {
            function n(n) {
                n.each(function () {
                    ...
                    if (
                        ("bottom" === r || "top" === r
                            ? ((n = Bo), (w = "x"), (k = "y"), (S = "x2"), (E = "y2"), C.attr("dy", 0 > L ? "0em" : ".71em").style("text-anchor", "middle"), _.attr("d", "M" + x[0] + "," + L * i + "V0H" + x[1] + "V" + L * i))
                            : ((n = Wo), (w = "y"), (k = "x"), (S = "y2"), (E = "x2"), C.attr("dy", ".32em").style("text-anchor", 0 > L ? "end" : "start"), _.attr("d", "M" + L * i + "," + x[0] + "H0V" + x[1] + "H" + L * i)),
                        A.attr(E, L * u),
                        z.attr(k, L * M),
    ...
    ta.svg.brush = function () {
        ...
        return (
            ...
            (n.extent = function (t) {
                var e, r, u, i, c;
                return arguments.length
                    ? (l && ((e = t[0]), (r = t[1]), s && ((e = e[0]), (r = r[0])), (o = [e, r]), l.invert && ((e = l(e)), (r = l(r))), e > r && ((c = e), (e = r), (r = c)), (e != f[0] || r != f[1]) && (f = [e, r])),
                      s && ((u = t[0]), (i = t[1]), l && ((u = u[1]), (i = i[1])), (a = [u, i]), s.invert && ((u = s(u)), (i = s(i))), u > i && ((c = u), (u = i), (i = c)), (u != h[0] || i != h[1]) && (h = [u, i])),
                      n)
                    : (l && (o ? ((e = o[0]), (r = o[1])) : ((e = f[0]), (r = f[1]), l.invert && ((e = l.invert(e)), (r = l.invert(r))), e > r && ((c = e), (e = r), (r = c)))),
                      s && (a ? ((u = a[0]), (i = a[1])) : ((u = h[0]), (i = h[1]), s.invert && ((u = s.invert(u)), (i = s.invert(i))), u > i && ((c = u), (u = i), (i = c)))),
                      l && s
                          ? [
                                [e, u],
                                [r, i],
