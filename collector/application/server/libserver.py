...
class Message:
    ...
    def _read(self, total_length=None):
        try:
            if not total_length:
    ...
    def _create_response_json_content(self):
        ...
        if action == "config-sync":
            content = {"result": self._config.get("COLLECTOR"),
                       "request_type": "config-sync"
                       }
        else:
    ...
    def read(self):
        ...
        if len(self._recv_buffer) < self.jsonheader["content-length"]:
